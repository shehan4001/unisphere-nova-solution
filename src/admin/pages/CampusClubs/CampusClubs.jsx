      ...
      >
                ...
                <tr key={req._id}>
                  ...
                  <td>
                    <div className="action-btns">
                      <button className="btn-approve" onClick={() => handleAction(req._id, 'accept')}>
                        Approve
                      </button>
        ...
        <section className="requests-section" style={{ marginTop: '40px' }}>
          ...
          <table className="requests-table">
            ...
            <tbody>
              {allClubs.length > 0 ? allClubs.map(club => (
                <tr key={club.ClubID}>
                  <td>{club.Name}</td>
                  <td><span className="club-tag">{club.Category}</span></td>
                  <td>
                    <div className="action-btns">
                      <button className="btn-edit" onClick={() => startEdit(club)}>
                        Edit
                      </button>
                      <button className="btn-delete" onClick={() => handleDeleteClub(club.ClubID)}>
                        Delete
                      </button>
                    </div>
                  </td>
