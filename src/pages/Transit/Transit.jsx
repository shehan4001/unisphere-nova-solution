...
const ROUTES = [
  {
    ...
    sub: "Via Sudarshana Mw · Balummahara",
    time: "7:00 AM",
    status: "active",
    label: "ACTIVE",
  },
  {
    name: "CINEC → Malabe Town",
    sub: "Short campus shuttle",
    time: "8:30 AM",
    status: "inactive",
    label: "INACTIVE",
  },
  {
    name: "CINEC → Colombo",
    sub: "Malabe · Battaramulla · Rajagiriya · Borella · Colombo Fort",
    time: "9:00 AM",
    status: "inactive",
    label: "INACTIVE",
  },
  ...
  return (
    ...
    >
      ...
      <div className="rir">
        ...
        <div className={`rstatus ${route.status}`}>
          {route.label}
        </div>
      </div>
    </div>
              ...
              <div className="overlay-sidebar">
                ...
                <div className="sidebar-header">
                  ...
                  <div className="sh-sub">
                    Estimated arrival at your closest stop
                  </div>
                </div>
